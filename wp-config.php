...
define( 'WPCACHEHOME', 'C:\xampp_secondtry\htdocs\BekesWordPress\wp-content\plugins\wp-super-cache/' );
define('DB_NAME', 'bekes_wp');

/** MySQL felhasználónév */
define('DB_USER', 'bekes_wp_user');

/** MySQL jelszó. */
define('DB_PASSWORD', 'Aevum192813');

/** MySQL  kiszolgáló neve */
define('DB_HOST', 'www.bekestemetkezes.hu');
